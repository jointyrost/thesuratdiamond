                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="inner">
                            <div class="bradcrumb-thumb">
                                <img src="{{ url('user/assets/images/logo/logo.png') }}" alt="Image">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="axil-shop-top">
                            <form id="filterForm" method="GET" action="{{ route('browse.collection')}}">
                                <div class="row">
                                    <div class="col-lg-9">
...
<script>
    function clearFilters() {
        ...
        window.location.href = "{{ route('clear.filter.browse.collection') }}";
    }
</script>
<script>
